...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        hidden_outputs = self.activation_function(np.dot(self.weights_input_to_hidden.T, hidden_inputs)) # signals from hidden layer
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        output_error_term = error # There is no activation function in the last node
